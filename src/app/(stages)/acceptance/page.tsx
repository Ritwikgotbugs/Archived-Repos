...
import { db } from "@/firebase/client"; // Make sure to point to your firebase config
...
import { useState } from "react";
    ...
    return (
        <div className="bg-white p-6 max-w-screen mx-40">
        <h1 className="text-5xl font-bold mb-4 mt-20">Acceptance</h1>
        ...
        <p className="italic text-gray-600 mb-4 text-xl text-center">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <h2 className="text-xl font-bold mb-2">1. Practice Self-Kindness</h2>
            <p className="mb-2">
            ...
            <h2 className="text-xl font-bold mb-2">2. Embrace Common Humanity</h2>
            <p className="mb-2">
            ...
            <h2 className="text-xl font-bold mb-2">3. Cultivate Mindfulness</h2>
            <p className="mb-2">
